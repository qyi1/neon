...
def trans_F_4x4_3x3(Fw, F, minimal=False, trans=False):
    if minimal:
        ...
        for O, I in ((T0, F), (T1, T0.T)):
            ...
            t0 = 0.26890756302521 * I[2,:]
	    t1 = -0.688403361344538 * I[0,:] - t0
	    t2 = 0.119514472455649 * I[0,:] + t0

            O[0,:] = I[0,:] * 1.13777777777778
            O[1,:] = t1 - 0.430252100840336 * I[1,:]
            O[2,:] = t1 + 0.430252100840336 * I[1,:]
            O[3,:] = t2 + 0.179271708683473 * I[1,:]
            O[4,:] = t2 - 0.179271708683473 * I[1,:]
            O[5,:] = I[2,:]
